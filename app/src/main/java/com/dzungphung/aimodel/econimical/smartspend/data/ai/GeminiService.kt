...
IMPORTANT: Return ONLY the raw JSON. No markdown formatting, no code blocks, no explanations."""
     ...
     */
    suspend fun analyzeSpending(expenses: List<Expense>, period: String, budget: Double? = null, currencyFormat: NumberFormat = NumberFormat.getCurrencyInstance()): String? {
