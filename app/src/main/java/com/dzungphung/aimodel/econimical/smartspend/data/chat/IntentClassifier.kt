package com.dzungphung.aimodel.econimical.smartspend.data.chat

import android.content.Context
import android.util.Log
import com.dzungphung.aimodel.econimical.smartspend.data.ai.DeviceCapabilityManager
...
class IntentClassifier @Inject constructor(
    ...
    private val currentTier: DeviceCapabilityManager.ModelTier
    ...
    fun classify(text: String): String {
        return try {
            when {
                ...
                currentTier == DeviceCapabilityManager.ModelTier.LITE -> simpleHeuristicClassify(text)
     ...
     */
    fun getCurrentTier(): DeviceCapabilityManager.ModelTier = currentTier
